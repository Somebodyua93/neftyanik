$(document).ready(function() {
   ...
   return false;
	...
	$("#look-apartment").submit(function() {
		$.ajax({
			type: "GET",
			url: "look-apartment.php",
			data: $("#look-apartment").serialize()
		}).done(function() {
			location.href = "thankyou.html";
			setTimeout(function() {
				$.fancybox.close();
	...
	$("#application2").submit(function() {
		$.ajax({
			type: "GET",
			url: "send2.php",
			data: $("#application2").serialize()
		}).done(function() {
			location.href = "thankyou.html";
			setTimeout(function() {
				$.fancybox.close();
	...
	$("#application3").submit(function() {
		$.ajax({
			type: "GET",
			url: "send3.php",
			data: $("#application3").serialize()
		}).done(function() {
			location.href = "thankyou.html";
			setTimeout(function() {
				$.fancybox.close();
